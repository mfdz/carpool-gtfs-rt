...
/**
 * https://github.com/dropwizard/dropwizard/issues/1567 Override getLoggingFactory for your
 * configuration
 */
public class LogbackAutoConfigLoggingFactory implements LoggingFactory {

    @JsonIgnore private LoggerContext loggerContext;
    @JsonIgnore private final ContextInitializer contextInitializer;
